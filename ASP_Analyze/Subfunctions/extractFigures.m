function extractFigures(E,multiSession,corrected)
...
if corrected == 0
    ...
    for dr = 1:2
        ...
        for stim = [2 3 5]
            ...
            %PiS1 = plot(-250:1449,E.AV.s_avtl_trial(:,stim,2,dr));
            PiS2 = plot(-150:1449,E.AV.s_avtl_trial(:,stim,3,dr));
            PiS3 = plot(-150:1449,E.AV.s_avtl_trial(:,stim,4,dr));
            PiS4 = plot(-150:1449,E.AV.s_avtl_trial(:,stim,5,dr));
            PiS5 = plot(-150:1449,E.AV.s_avtl_trial(:,stim,6,dr));
            hold off
    ...
    for HB = 1:3
        ...
        for dr = 1:2
            ...
            for stim = 1:3
                ...
                %plot((E.tEvents(3)-E.tEvents(2)+50)*[1 1],[-20 20],'c');
                %PiS1 = plot(-250:1449,E.AV.s_avtl_trial(:,stim,2,dr));
                PiS2 = plot(-150:1449,E.AV.m_avtl_trial(:,stim,3,dr,HB));
                PiS3 = plot(-150:1449,E.AV.m_avtl_trial(:,stim,4,dr,HB));
                PiS4 = plot(-150:1449,E.AV.m_avtl_trial(:,stim,5,dr,HB));
                PiS5 = plot(-150:1449,E.AV.m_avtl_trial(:,stim,6,dr,HB));
                hold off
                %legend([PiS1 PiS2 PiS3 PiS4 PiS5],{'PiS 1','PiS 2','PiS 3','PiS 4','PiS 5'});
                legend([PiS2 PiS3 PiS4 PiS5],{'PiS 2','PiS 3','PiS 4','PiS 5'});
                xlabel('time after blank onset [ms]');
...
if corrected == 0
    ...
    for dr = 1:2
        ...
        for stim = [2 3 5]
            ...
            %PiS1 = plot(-250:1449,E.AV.s_avtl_trial(:,stim,2,dr));
            PiS2 = plot(400:600,E.AV.s_avtl_trial(550:750,stim,3,dr));
            PiS3 = plot(400:600,E.AV.s_avtl_trial(550:750,stim,4,dr));
            PiS4 = plot(400:600,E.AV.s_avtl_trial(550:750,stim,5,dr));
            PiS5 = plot(400:600,E.AV.s_avtl_trial(550:750,stim,6,dr));
            hold off
            %legend([PiS1 PiS2 PiS3 PiS4 PiS5],{'PiS 1','PiS 2','PiS 3','PiS 4','PiS 5'});
            legend([PiS2 PiS3 PiS4 PiS5],{'PiS 2','PiS 3','PiS 4','PiS 5'});
            xlabel('time after blank onset [ms]');
    ...
    for HB = 1:3
        ...
        for dr = 1:2
            ...
            for stim = 1:3
                ...
                plot((E.tEvents(2)+500)*[1 1],[-40 40],'k');
                %PiS1 = plot(-250:1449,E.AV.s_avtl_trial(:,stim,2,dr));
                PiS2 = plot(400:600,E.AV.m_avtl_trial(550:750,stim,3,dr,HB));
                PiS3 = plot(400:600,E.AV.m_avtl_trial(550:750,stim,4,dr,HB));
                PiS4 = plot(400:600,E.AV.m_avtl_trial(550:750,stim,5,dr,HB));
                PiS5 = plot(400:600,E.AV.m_avtl_trial(550:750,stim,6,dr,HB));
                hold off
                %legend([PiS1 PiS2 PiS3 PiS4 PiS5],{'PiS 1','PiS 2','PiS 3','PiS 4','PiS 5'});
                legend([PiS2 PiS3 PiS4 PiS5],{'PiS 2','PiS 3','PiS 4','PiS 5'});
                xlabel('time after blank onset [ms]');
...
if corrected == 0
    ...
    for dr = 1:2
        ...
        for stim = [2 3 5]
            ...
            plot((E.tEvents(3)-E.tEvents(2)+50)*[1 1],[-20 20],'c');
            pPiS1 = plot(1:600,E.AV.s_avtl_blank(:,stim,2,dr));
            pPiS2 = plot(1:600,E.AV.s_avtl_blank(:,stim,3,dr));
            pPiS3 = plot(1:600,E.AV.s_avtl_blank(:,stim,4,dr));
            pPiS4 = plot(1:600,E.AV.s_avtl_blank(:,stim,5,dr));
            pPiS5 = plot(1:600,E.AV.s_avtl_blank(:,stim,6,dr));
            hold off
    ...
    for HB = 1:3
        ...
        for dr = 1:2
            for stim = 1:3
                ...
                plot((E.tEvents(3)-E.tEvents(2))*[1 1],[-20 20],'k');
                plot((E.tEvents(3)-E.tEvents(2)+50)*[1 1],[-20 20],'c');
                pPiS1 = plot(1:600,E.AV.m_avtl_blank(:,stim,2,dr,HB));
                pPiS2 = plot(1:600,E.AV.m_avtl_blank(:,stim,3,dr,HB));
                pPiS3 = plot(1:600,E.AV.m_avtl_blank(:,stim,4,dr,HB));
                pPiS4 = plot(1:600,E.AV.m_avtl_blank(:,stim,5,dr,HB));
                pPiS5 = plot(1:600,E.AV.m_avtl_blank(:,stim,6,dr,HB));
                hold off
                legend([pPiS1 pPiS2 pPiS3 pPiS4 pPiS5],{'pPiS 1','pPiS 2','pPiS 3','pPiS 4','pPiS 5'});
                xlabel('time after blank onset [ms]');
                ylabel('Velocity diff [deg/s]');
...
if corrected == 0
    ...
    for dr = 1:2
        ...
        Stim1Hex1 = plot(1:400,E.AV.s_avtl_blip(:,2,2,dr));
        Stim2Hex1 = plot(1:400,E.AV.s_avtl_blip(:,3,2,dr));
        Stim1Hex2 = plot(1:400,E.AV.s_avtl_blip(:,2,4,dr));
        Stim2Hex2 = plot(1:400,E.AV.s_avtl_blip(:,3,4,dr));
        hold off
    ...
    for dr = 1:2
        ...
        DiffHex1 = plot(1:400,E.AV.s_avtl_blip(:,2,5,dr));
        DiffHex2 = plot(1:400,E.AV.s_avtl_blip(:,3,5,dr));
        hold off
...
if multiSession == 1
    ...
    for HB = 1:3
        ...
        for dr = 1:2
            ...
            plot((E.bliptimes(2,1,dr)-E.tEvents(4))*[1 1],[-30 30],'k');
            plot((E.bliptimes(4,1,dr)-E.tEvents(4))*[1 1],[-30 30],'k');
            Stim1Hex1 = plot(1:400,E.AV.m_avtl_blip(:,1,2,dr,HB));
            Stim2Hex1 = plot(1:400,E.AV.m_avtl_blip(:,2,2,dr,HB));
            Stim1Hex2 = plot(1:400,E.AV.m_avtl_blip(:,1,4,dr,HB));
            Stim2Hex2 = plot(1:400,E.AV.m_avtl_blip(:,2,4,dr,HB));
            hold off
        ...
        for dr = 1:2
            ...
            plot((E.bliptimes(2,1,dr)-E.tEvents(4))*[1 1],[-6 6],'k');
            plot((E.bliptimes(4,1,dr)-E.tEvents(4))*[1 1],[-6 6],'k');
            DiffHex1 = plot(1:400,E.AV.m_avtl_blip(:,1,5,dr,HB));
            DiffHex2 = plot(1:400,E.AV.m_avtl_blip(:,2,5,dr,HB));
            hold off
...
%% Saccade times for single-session
if corrected == 0
    limits = {[-150 1450 0 1];[-150 1450 0 1];[-150 1450 -0.5 0.5];[-150 1450 0 1];[-150 1450 0 1];[-150 1450 -0.5 0.5]};
    figTrialSingle = figure('Name','figTrialSingle');
    plots = {'Left - No Stim';'Left - Stim';'Left - Difference';'Right - No Stim';'Right - Stim';'Right - Difference'};
    for dr = 1:2
        pc = 1;
        for HB = [2 3 5]
            subplot(2,3,3*dr+pc-3);
            ...
            plot([-150 1450],[0 0],'k');
            plot([0 0],[-40 40],'b');
            plot(460*[1 1],[-40 40],'k');
            plot(530*[1 1],[-40 40],'k');
            plot((E.bliptimes(2,1,dr)-E.tEvents(2))*[1 1],[-40 40],'k');
            plot((E.bliptimes(4,1,dr)-E.tEvents(2))*[1 1],[-40 40],'k');
            plot((E.tEvents(6)-E.tEvents(2))*[1 1],[-40 40],'k');
            DeIn = plot(-150:1449,E.AV.s_sacc_times(:,2,dr,HB));
            Zero = plot(-150:1449,E.AV.s_sacc_times(:,3,dr,HB));
            InDe = plot(-150:1449,E.AV.s_sacc_times(:,4,dr,HB));
            hold off
            legend([DeIn Zero InDe],{'De/In','Zero','In/De'});
            xlabel('time after blank onset [ms]');
            ylabel('% Saccades');
            title(plots(3*dr+pc-3));
            axis(cell2mat(limits(3*dr+pc-3)));
    ...
    savefig(figTrialSingle,strcat(E.name(1:4),'_SaccadeTimes(Total).fig'));
    saveas(figTrialSingle,strcat(E.name(1:4),'_SaccadeTimes(Total).svg'));
    close figTrialSingle;
end
%% Saccade times for multi-session
if corrected == 0
    if multiSession == 1
        limits = {[-150 1450 0 1];[-150 1450 0 1];[-150 1450 -0.5 0.5];[-150 1450 0 1];[-150 1450 0 1];[-150 1450 -0.5 0.5]};
        for HB = 1:3
            figSaccMulti = figure('Name','figSaccMulti');
            plots = {'Left - Session A';'Left - Session C';'Left - Difference';'Right - Session A';'Right - Session C';'Right - Difference'};
            for dr = 1:2
                pc = 1;
                for stim = 1:3
                    ...
                    %plot((E.tEvents(3)-E.tEvents(2)+50)*[1 1],[-20 20],'c');
                    %PiS1 = plot(-250:1449,E.AV.s_avtl_trial(:,stim,2,dr));
                    DeIn = plot(-150:1449,E.AV.m_sacc_times(:,2,stim,dr,HB));
                    Zero = plot(-150:1449,E.AV.m_sacc_times(:,3,stim,dr,HB));
                    InDe = plot(-150:1449,E.AV.m_sacc_times(:,4,stim,dr,HB));
                    hold off
                    legend([DeIn Zero InDe],{'De/In','Zero','In/De'});
                    xlabel('time after blank onset [ms]');
                    ylabel('% Saccades');
            ...
            savefig(figSaccMulti,strcat(E.name(1:4),'_SaccadeTimes(',multiCond(HB),').fig'));
            saveas(figSaccMulti,strcat(E.name(1:4),'_SaccadeTimes(',multiCond(HB),').svg'));
            close figSaccMulti;
        end
    end
end
